...
// add a module
router.post('/add', verifyLogin, verifyAdmin, (req, res) => {
...
router.patch('/edit/:id', verifyLogin, verifyAdmin, (req, res) => {
...
router.delete('/delete/:id', verifyLogin, verifyAdmin, (req, res) => {
  const moduleID = req.params.id
